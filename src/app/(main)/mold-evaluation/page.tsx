  ...
  return (
    <>
      <ServiceStructuredData
        ...
        path="/mold-evaluation"
      />
      <BreadcrumbStructuredData
        items={[
          { name: "Home", url: "https://brestorations.com" },
          {
            name: service?.label || "Mold Evaluation",
      ...
      <main>
        ...
        >
          <div className="absolute top-0 left-0 -z-1 h-full w-full">
            <OptimizedVideo
              src={HERO_VIDEOS.moldEvaluation.src}
              poster={HERO_VIDEOS.moldEvaluation.poster}
              alt={HERO_VIDEOS.moldEvaluation.alt}
