    ...
    <>
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          {
            name: service?.label || "Water Damage",
      ...
      <main>
        ...
        >
          <div className="absolute top-0 left-0 -z-1 h-full w-full">
            <OptimizedVideo
              src={HERO_VIDEOS.waterDamage.src}
              poster={HERO_VIDEOS.waterDamage.poster}
              alt={HERO_VIDEOS.waterDamage.alt}
        ...
        <section id="services" className="bg-white px-6 py-12 md:py-20">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 md:grid-cols-2 md:gap-12 lg:grid-cols-12 lg:gap-20">
            ...
            >
              <Eyebrow>
                {timeline1?.eyebrow || "24/7 Emergency Service"}
              </Eyebrow>
