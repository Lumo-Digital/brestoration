...
export const HERO_VIDEOS = {
  ...
  waterDamage: {
    src: "https://res.cloudinary.com/dmsciazqx/video/upload/q_auto,f_auto/v1766446327/blue-restoration/videos/water-damage/water-hero.mp4",
  ...
  stormDamage: {
    src: "https://res.cloudinary.com/dmsciazqx/video/upload/q_auto,f_auto/v1766446331/blue-restoration/videos/storm-damage/storm-hero.mp4",
    poster: "/images/posters/storm_poster.png",
    alt: "Storm damage repair and emergency restoration",
  },
  moldEvaluation: {
    src: "https://res.cloudinary.com/dmsciazqx/video/upload/q_auto,f_auto/v1766446333/blue-restoration/videos/mold-evaluation/mold-hero.mp4",
